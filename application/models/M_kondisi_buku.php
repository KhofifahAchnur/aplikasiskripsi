...
class M_kondisi_buku extends CI_model
{
    ...
    {
        $this->db->select('kondisi_buku.id, buku.id_buku,buku.nama_buku, buku.kode_buku, buku.register, buku.judul, kondisi_buku.kondisi, kondisi_buku.tanggal');
    ...
    // public function lihat()
	// {
	// 	$this->db->select('kondisi_buku.id, buku.id_buku, buku.nama_buku, 
	// 	buku.kode_buku, buku.register, kondisi_buku.kondisi, kondisi_buku.tanggal');
	// 	$this->db->from('kondisi_buku');
	// 	$this->db->join('buku', 'buku.id_buku = kondisi_buku.buku_id ');
	// 	$this->db->order_by('kondisi_buku.id_buku', 'DESC');
	// 	return $this->db->get()->result_array();
	// }

	// public function lihatkondisibyid($id)
	// {
	// 	$this->db->select('kondisi_buku.id_buku, buku.nama_buku, 
	// 	buku.kode_buku, buku.register, kondisi_buku.kondisi, kondisi_buku.tanggal');
	// 	$this->db->from('kondisi_buku');
	// 	$this->db->join('buku', 'buku.id_buku = kondisi_buku.buku_id ');
	// 	$this->db->where('kondisi_buku.buku_id', $id);
