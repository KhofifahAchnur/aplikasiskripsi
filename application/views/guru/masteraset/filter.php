            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <!-- Input Filter -->
                            <form action="<?= base_url(); ?>/guru/MasterAset/filter">
                                ...
                                <?php if (isset($_GET['filter'])) : ?>
                                    <a href="<?= base_url('guru/masteraset/filter'); ?>" class="btn btn-default">RESET</a>
                                <?php endif; ?>
                            </form>
                            <!-- End Input Filter -->
                            <br>
                            ...
                            <?php if (isset($_GET['filter'])) : ?>
                                ...
                                <?php if (isset($_GET['nama'])) : ?>
                                    <form action="<?= base_url('guru/MasterAset/laporan'); ?>" target="_blank">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <!-- <a href="<?= base_url('guru/kondisi/tambah'); ?>" class="badge badge-pill badge-success">UBAH KONDISI</a> -->
                                                    <a href="<?= base_url(); ?>guru/kondisi/tambah/<?= $brg['id']; ?>" class="badge badge-pill badge-info">UBAH KONDISI</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <tfoot>
