            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form action="<?= base_url(); ?>/guru/buku/filter">
                                <div class="row">
                                    <div class="col-6">
                                ...
                                <?php if (isset($_GET['filter'])) : ?>
                                    <a href="<?= base_url('guru/buku/filter'); ?>" class="btn btn-default">RESET</a>
                                <?php endif; ?>
                            </form>
                            <br>
                            <?php if (isset($_GET['filter'])) : ?>
                                <p>Tanggal : <?= $tgl_awal; ?> sd <?= $tgl_akhir; ?></p>
                                <form action="<?= base_url('guru/buku/laporan'); ?>" target="_blank">
