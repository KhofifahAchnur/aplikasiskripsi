...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Data History Aset Buku / Kepustakaan</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <a href="<?= base_url('guru/buku/index') ?>" button type="button" class="btn waves-effect waves-light btn-secondary"><i class="fas fa-arrow-left"></i>&nbsp;&nbsp;Kembali</a> |
                        <!-- <a href="<?= base_url('guru/hbuku/laporan/') . $buku['id_buku'] ?>" class="btn waves-effect waves-light btn-info" style="float:left"><i class="fas fas fa-print"></i>&nbsp;&nbsp;</a> -->
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                        ...
                        <form action="" method="post">
                            ...
                            <div class="card-body">
                                ...
                                <!-- <div class="text-center">
                                    ...
                                    <!-- <a href="<?= base_url('guru/pemeliharaan/tambah/') . $gedung['id_gedung'] ?>" button type="button" class="btn btn-info"></button> &nbsp;&nbsp;Pemeliharaan</a>
                                </div> -->
                            </div>
                        </form>
                    </div>
