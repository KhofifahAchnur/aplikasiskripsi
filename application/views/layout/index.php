            ...
            <div class="row">
                <div class="col-lg-6 col-2">
                    ...
                    <div class="small-box bg-success">
                        ...
                        <a href="<?= base_url('admin/tanah') ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-6 col-2">
                    ...
                    <div class="small-box bg-info">
                        ...
                        <a href="<?= base_url('admin/masteraset') ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-6 col-2">
                ...
                <div class="col-lg-12 col-2">
                    ...
                    <div class="small-box bg-primary">
                        ...
                        <a href="<?= base_url('admin/jalan') ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
            </div>
