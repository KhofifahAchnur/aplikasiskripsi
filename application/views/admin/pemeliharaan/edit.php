            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card card-info">
                        ...
                        <?php echo form_open_multipart('admin/pemeliharaan/update_aksi'); ?>
                        <input type="hidden" name="id_pemeliharaan" value="<?= $pemeliharaan['id_pemeliharaan']; ?>">
                        <input type="hidden" name="buktilama" value="<?= $pemeliharaan['bukti']; ?>">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" for="exampleInputFile"> <?= $pemeliharaan['bukti'] ?> </label>
                                    </div>
                                </div>
                            </div>
