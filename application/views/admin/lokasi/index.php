                ...
                <?php if ($this->session->flashdata('flash')) : ?>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="<?= base_url('admin/lokasi/tambah') ?>" button type="button" class="btn waves-effect waves-light btn-success" style="float:right"><i class="fas fa-plus"></i>&nbsp;&nbsp;Tambah</a>
                            <a href="<?= base_url('admin/lokasi/laporan') ?>" button type="button" class="btn waves-effect waves-light btn-success" style="float:left"><i class="fas fas fa-print"></i>&nbsp;&nbsp;</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
