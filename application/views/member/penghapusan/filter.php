            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <!-- Input Filter -->
                            <form action="<?= base_url(); ?>/member/penghapusan/filter">
                                ...
                                <?php if (isset($_GET['filter'])) : ?>
                                    <a href="<?= base_url('member/penghapusan/filter'); ?>" class="btn btn-default">RESET</a>
                                <?php endif; ?>
                            </form>
                            <!-- End Input Filter -->
                            <br>
                            ...
                            <?php if (isset($_GET['filter'])) : ?>
                                ...
                                <?php if (isset($_GET['nama_barang'])) : ?>
                                    <form action="<?= base_url('member/Penghapusan/laporan'); ?>" target="_blank">
                                        ...
                                        foreach ($hapus as $hps) : ?>
                                            <tr>
                                                ...
                                                <td style="width: 100px;" class="text-center">
                                                    ...
                                                    <a href="<?= base_url(); ?>member/penghapusan/hapus/<?= $hps['id']; ?>" class="btn-danger  btn-sm" title="hapus" onclick="return confirm('Yakin ingin menghapus data?');"><i class="fas fa-trash-alt"></i></a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
