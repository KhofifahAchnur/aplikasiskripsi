                                    ...
                                    <tbody>
                                        <?php foreach ($aset as $index => $brg) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <!-- <a href="<?= base_url('member/kondisi/tambah'); ?>" class="badge badge-pill badge-success">UBAH KONDISI</a> -->
                                                    <!-- <a href="<?= base_url(); ?>member/kondisi/tambah/<?= $brg['id']; ?>" class="badge badge-pill badge-success">UBAH KONDISI</a> -->
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
