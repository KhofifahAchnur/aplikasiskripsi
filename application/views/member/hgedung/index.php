            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <!-- <a href="<?= base_url('member/hgedung/laporan/') . $gedung['id_gedung'] ?>" class="btn waves-effect waves-light btn-info" style="float:left"><i class="fas fas fa-print"></i>&nbsp;&nbsp;</a> -->
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                        ...
                        <form action="" method="post">
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-center">
                                    ...
                                    <a href="<?= base_url('member/pemeliharaan/tambah/') . $gedung['id_gedung'] ?>" button type="button" class="btn btn-secondary"></button> &nbsp;&nbsp;Pemeliharaan</a>
                                </div>
                            </div>
                        </form>
                    </div>
