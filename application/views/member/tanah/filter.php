            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form action="<?= base_url(); ?>/admin/tanah/filter">
                                <div class="row">
                                    <div class="col-6">
                                ...
                                <?php if (isset($_GET['filter'])) : ?>
                                    <a href="<?= base_url('admin/tanah/filter'); ?>" class="btn btn-default">RESET</a>
                                <?php endif; ?>
                            </form>
                            <br>
                            <?php if (isset($_GET['filter'])) : ?>
                                <p>Tanggal : <?= $tgl_awal; ?> sd <?= $tgl_akhir; ?></p>
                                <form action="<?= base_url('admin/tanah/laporan'); ?>" target="_blank">
