...
class Aset extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('guru/aset/index', $data);
    ...
    public function tambah()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layoutguru/topbar');
            $this->load->view('layoutguru/sidebar');
            $this->load->view('guru/aset/tambah');
            $this->load->view('layoutguru/footer');
        } else {
    ...
    public function edit($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layoutguru/topbar');
            $this->load->view('layoutguru/sidebar');
            $this->load->view('guru/aset/edit', $data);
            $this->load->view('layoutguru/footer');
        } else {
    ...
    public function laporan()
    {
        ...
        $data['barang'] = $this->M_aset->lihat();
        $this->load->view('guru/aset/laporan', $data);
        ...
        $html = $this->load->view('guru/aset/laporan', $this->data, true);
