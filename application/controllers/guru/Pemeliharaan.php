...
class Pemeliharaan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('guru/pemeliharaan/index', $data);
    ...
    public function tambah($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layoutguru/topbar');
            $this->load->view('layoutguru/sidebar');
            $this->load->view('guru/pemeliharaan/tambah', $data);
            $this->load->view('layoutguru/footer');
        } else {
    ...
    public function edit($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layoutguru/topbar');
            $this->load->view('layoutguru/sidebar');
            $this->load->view('guru/pemeliharaan/edit', $data);
            $this->load->view('layoutguru/footer');
        } else {
    ...
    public function filter()
    {
        ...
        $this->load->view('layoutguru/topbar');
        $this->load->view('layoutguru/sidebar');
        $this->load->view('guru/pemeliharaan/filter', $data);
        $this->load->view('layoutguru/footer');
    }
