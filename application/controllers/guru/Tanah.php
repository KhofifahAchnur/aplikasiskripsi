...
class Tanah extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('guru/tanah/index', $data);
    ...
    public function tambah()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layoutguru/topbar');
            $this->load->view('layoutguru/sidebar');
            $this->load->view('guru/tanah/tambah');
            $this->load->view('layoutguru/footer');
        } else {
    ...
    public function edit($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layoutguru/topbar');
            $this->load->view('layoutguru/sidebar');
            $this->load->view('guru/tanah/edit', $data);
            $this->load->view('layoutguru/footer');
        } else {
    ...
    public function filter()
    {
        ...
        $this->load->view('layoutguru/topbar');
        $this->load->view('layoutguru/sidebar');
        $this->load->view('guru/tanah/filter');
        $this->load->view('layoutguru/footer');
    }
    ...
    public function laporan()
    {
        ...
        $this->load->view('guru/tanah/laporan', $data);
        ...
        $html = $this->load->view('guru/tanah/laporan', $this->data, true);
