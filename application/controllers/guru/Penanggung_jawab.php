...
class Penanggung_jawab extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('guru/penanggung_jawab/index', $data);
    ...
    public function tambah()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layoutguru/topbar');
            $this->load->view('layoutguru/sidebar');
            $this->load->view('guru/penanggung_jawab/tambah');
            $this->load->view('layoutguru/footer');
        } else {
            $this->M_penanggung_jawab->proses_tambah();
            $this->session->set_flashdata('flash', 'Ditambahkan');
            redirect('guru/penanggung_jawab');
        }
    }
    ...
    public function edit($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layoutguru/topbar');
            $this->load->view('layoutguru/sidebar');
            $this->load->view('guru/penanggung_jawab/edit', $data);
            $this->load->view('layoutguru/footer');
        } else {
    ...
    public function laporan()
    {
        ...
        $data['barang'] = $this->M_penanggung_jawab->lihat();
        $this->load->view('guru/penanggung_jawab/laporan', $data);
        ...
        $html = $this->load->view('guru/penanggung_jawab/laporan', $this->data, true);
