...
class Kondisi_buku extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('guru/kondisi_buku/index', $data);
    ...
    public function tambah($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layoutguru/topbar');
            $this->load->view('layoutguru/sidebar');
            $this->load->view('guru/kondisi_buku/tambah', $data);
            $this->load->view('layoutguru/footer');
        } else {
    ...
    public function laporan()
    {
        ...
        $data['kondisi_buku'] = $this->M_kondisi_buku->lihat();
        $this->load->view('guru/kondisi_buku/laporan', $data);
        ...
        $html = $this->load->view('guru/kondisi_buku/laporan', $this->data, true);
