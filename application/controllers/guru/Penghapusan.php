...
class Penghapusan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('guru/penghapusan/index', $data);
    ...
    public function tambah($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layoutguru/topbar');
            $this->load->view('layoutguru/sidebar');
            $this->load->view('guru/penghapusan/tambah', $data);
            $this->load->view('layoutguru/footer');
        } else {
            $this->M_penghapusan->proses_tambah();
            $this->session->set_flashdata('flash', 'Ditambahkan');
            redirect('guru/penghapusan');
        }
    }
    ...
    public function filter()
    {
        ...
        $this->load->view('layoutguru/topbar');
        $this->load->view('layoutguru/sidebar');
        $this->load->view('guru/penghapusan/filter');
        $this->load->view('layoutguru/footer');
    }
    ...
    public function laporan()
    {
        ...
        // die($tgl_awal);
        $this->load->view('guru/penghapusan/laporan', $data);
        // title dari pdf
        ...
        $html = $this->load->view('guru/penghapusan/laporan', $this->data, true);
