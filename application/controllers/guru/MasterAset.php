...
class MasterAset extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('guru/masteraset/index', $data);
    ...
    public function filter()
    {
        ...
        $this->load->view('layoutguru/topbar');
        $this->load->view('layoutguru/sidebar');
        $this->load->view('guru/masteraset/filter');
        $this->load->view('layoutguru/footer');
    }
    ...
    public function laporan()
    {
        ...
        // die($tgl_awal);
        $this->load->view('guru/masteraset/laporan', $data);
        // title dari pdf
        ...
        $html = $this->load->view('guru/masteraset/laporan', $this->data, true);
