...
class Gedung extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('guru/gedung/index', $data);
    ...
    public function tambah()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layoutguru/topbar');
            $this->load->view('layoutguru/sidebar');
            $this->load->view('guru/gedung/tambah');
            $this->load->view('layoutguru/footer');
        } else {
            $this->M_gedung->proses_tambah();
            $this->session->set_flashdata('flash', 'Ditambahkan');
            redirect('guru/gedung');
        }
    }
    ...
    public function edit($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layoutguru/topbar');
            $this->load->view('layoutguru/sidebar');
            $this->load->view('guru/gedung/edit', $data);
            $this->load->view('layoutguru/footer');
        } else {
    ...
    public function filter()
    {
        ...
        $this->load->view('layoutguru/topbar');
        $this->load->view('layoutguru/sidebar');
        $this->load->view('guru/gedung/filter');
        $this->load->view('layoutguru/footer');
    }
    ...
    public function laporan()
    {
        ...
        $this->load->view('guru/gedung/laporan', $data);
        ...
        $html = $this->load->view('guru/gedung/laporan', $this->data, true);
