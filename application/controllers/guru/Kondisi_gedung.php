...
class Kondisi_gedung extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('guru/kondisi_gedung/index', $data);
    ...
    public function tambah($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layoutguru/topbar');
            $this->load->view('layoutguru/sidebar');
            $this->load->view('guru/kondisi_gedung/tambah', $data);
            $this->load->view('layoutguru/footer');
        } else {
    ...
    public function laporan()
    {
        ...
        $data['kondisi_gedung'] = $this->M_kondisi_gedung->lihat();
        $this->load->view('guru/kondisi_gedung/laporan', $data);
        ...
        $html = $this->load->view('guru/kondisi_gedung/laporan', $this->data, true);
