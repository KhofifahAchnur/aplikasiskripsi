...
class Perawatan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('guru/perawatan/index', $data);
    ...
    public function tambah($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layoutguru/topbar');
            $this->load->view('layoutguru/sidebar');
            $this->load->view('guru/perawatan/tambah', $data);
            $this->load->view('layoutguru/footer');
        } else {
    ...
    public function filter()
    {
        ...
        $this->load->view('layoutguru/topbar');
        $this->load->view('layoutguru/sidebar');
        $this->load->view('guru/perawatan/filter', $data);
        $this->load->view('layoutguru/footer');
    }
    ...
    public function laporan()
    {
        ...
        // die($tgl_awal);
        $this->load->view('guru/perawatan/laporan', $data);
        // title dari pdf
        ...
        $html = $this->load->view('guru/perawatan/laporan', $this->data, true);
