...
class Kgedung extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('guru/kgedung/index', $data);
    ...
    public function tambah($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layoutguru/topbar');
            $this->load->view('layoutguru/sidebar');
            $this->load->view('guru/kgedung/tambah', $data);
            $this->load->view('layoutguru/footer');
        } else {
    ...
    public function laporan()
    {
        ...
        $data['kgedung'] = $this->M_kgedung->lihat();
        $this->load->view('guru/kgedung/laporan', $data);
        ...
        $html = $this->load->view('guru/kgedung/laporan', $this->data, true);
