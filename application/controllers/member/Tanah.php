...
class Tanah extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('member/tanah/index', $data);
    ...
    public function tambah()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layoutmember/topbar');
            $this->load->view('layoutmember/sidebar');
            $this->load->view('member/tanah/tambah');
            $this->load->view('layoutmember/footer');
        } else {
            $this->M_tanah->proses_tambah();
            $this->session->set_flashdata('flash', 'Ditambahkan');
            redirect('member/tanah');
        }
    }
    ...
    public function filter()
    {
        ...
        $this->load->view('layoutmember/topbar');
        $this->load->view('layoutmember/sidebar');
        $this->load->view('member/tanah/filter');
        $this->load->view('layoutmember/footer');
    }
    ...
    public function laporan()
    {
        ...
        $this->load->view('member/tanah/laporan', $data);
        ...
        $html = $this->load->view('member/tanah/laporan', $this->data, true);
