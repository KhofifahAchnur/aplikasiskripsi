...
class Kbaru extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('member/kbaru/index', $data);
    ...
    public function tambah($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layoutmember/topbar');
            $this->load->view('layoutmember/sidebar');
            $this->load->view('member/kbaru/tambah', $data);
            $this->load->view('layoutmember/footer');
        } else {
    ...
    public function laporan()
    {
        ...
        $data['kbaru'] = $this->M_kbaru->lihat();
        $this->load->view('member/kbaru/laporan', $data);
        ...
        $html = $this->load->view('member/kbaru/laporan', $this->data, true);
