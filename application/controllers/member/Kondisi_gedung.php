...
class Kondisi_gedung extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('member/kondisi_gedung/index', $data);
    ...
    public function tambah($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layoutmember/topbar');
            $this->load->view('layoutmember/sidebar');
            $this->load->view('member/kondisi_gedung/tambah', $data);
            $this->load->view('layoutmember/footer');
        } else {
    ...
    public function laporan()
    {
        ...
        $data['kondisi_gedung'] = $this->M_kondisi_gedung->lihat();
        $this->load->view('member/kondisi_gedung/laporan', $data);
        ...
        $html = $this->load->view('member/kondisi_gedung/laporan', $this->data, true);
