...
class Kgedung extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('member/kgedung/index', $data);
    ...
    public function tambah($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layoutmember/topbar');
            $this->load->view('layoutmember/sidebar');
            $this->load->view('member/kgedung/tambah', $data);
            $this->load->view('layoutmember/footer');
        } else {
    ...
    public function laporan()
    {
        ...
        $data['kgedung'] = $this->M_kgedung->lihat();
        $this->load->view('member/kgedung/laporan', $data);
        ...
        $html = $this->load->view('member/kgedung/laporan', $this->data, true);
