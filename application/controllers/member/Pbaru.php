...
class Pbaru extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('member/pbaru/index', $data);
    ...
    public function tambah()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layoutmember/topbar');
            $this->load->view('layoutmember/sidebar');
            $this->load->view('member/pbaru/tambah', $data);
            $this->load->view('layoutmember/footer');
        } else {
            $this->M_pbaru->proses_tambah();
            $this->session->set_flashdata('flash', 'Ditambahkan');
            redirect('member/pbaru');
        }
    }
    ...
    public function edit($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layoutmember/topbar');
            $this->load->view('layoutmember/sidebar');
            $this->load->view('member/pbaru/edit', $data);
            $this->load->view('layoutmember/footer');
        } else {
    ...
    public function laporan()
    {
        ...
        $data['pbaru'] = $this->M_pbaru->lihat();
        $this->load->view('member/pbaru/laporan', $data);
        ...
        $html = $this->load->view('member/pbaru/laporan', $this->data, true);
