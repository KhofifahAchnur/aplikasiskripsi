...
class Pgedung extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('sapras/pgedung/index', $data);
    ...
    public function tambah()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layoutsapras/topbar');
            $this->load->view('layoutsapras/sidebar');
            $this->load->view('sapras/pgedung/tambah', $data);
            $this->load->view('layoutsapras/footer');
        } else {
    ...
    public function edit($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layoutsapras/topbar');
            $this->load->view('layoutsapras/sidebar');
            $this->load->view('sapras/pgedung/edit', $data);
            $this->load->view('layoutsapras/footer');
        } else {
    ...
    public function laporan()
    {
        ...
        $data['pgedung'] = $this->M_pgedung->lihat();
        $this->load->view('sapras/pgedung/laporan', $data);
        ...
        $html = $this->load->view('sapras/pgedung/laporan', $this->data, true);
