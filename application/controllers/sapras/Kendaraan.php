...
class Kendaraan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('sapras/kendaraan/index', $data);
    ...
    public function tambah()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layoutsapras/topbar');
            $this->load->view('layoutsapras/sidebar');
            $this->load->view('sapras/kendaraan/tambah');
            $this->load->view('layoutsapras/footer');
        } else {
            $this->M_kendaraan->proses_tambah();
            $this->session->set_flashdata('flash', 'Ditambahkan');
            redirect('sapras/kendaraan');
        }
    }
    ...
    public function edit($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layoutsapras/topbar');
            $this->load->view('layoutsapras/sidebar');
            $this->load->view('sapras/kendaraan/edit', $data);
            $this->load->view('layoutsapras/footer');
        } else {
    ...
    public function laporan()
    {
        ...
        $data['motor'] = $this->M_kendaraan->lihat();
        $this->load->view('sapras/kendaraan/laporan', $data);
        ...
        $html = $this->load->view('sapras/kendaraan/laporan', $this->data, true);
