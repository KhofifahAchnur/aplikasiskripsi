...
class Jalan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('sapras/jalan/index', $data);
    ...
    public function tambah()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layoutsapras/topbar');
            $this->load->view('layoutsapras/sidebar');
            $this->load->view('sapras/jalan/tambah');
            $this->load->view('layoutsapras/footer');
        } else {
            $this->M_jalan->proses_tambah();
            $this->session->set_flashdata('flash', 'Ditambahkan');
            redirect('sapras/jalan');
        }
    }
    ...
    public function edit($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layoutsapras/topbar');
            $this->load->view('layoutsapras/sidebar');
            $this->load->view('sapras/jalan/edit', $data);
            $this->load->view('layoutsapras/footer');
        } else {
    ...
    public function filter()
    {
        ...
        $this->load->view('layoutsapras/topbar');
        $this->load->view('layoutsapras/sidebar');
        $this->load->view('sapras/jalan/filter');
        $this->load->view('layoutsapras/footer');
    }
    ...
    public function laporan()
    {
        ...
        $this->load->view('sapras/jalan/laporan', $data);
        ...
        $html = $this->load->view('sapras/jalan/laporan', $this->data, true);
