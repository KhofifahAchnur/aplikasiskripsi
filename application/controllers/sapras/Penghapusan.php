...
class Penghapusan extends CI_Controller
{
    ...
    public function tambah($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layoutsapras/topbar');
            $this->load->view('layoutsapras/sidebar');
            $this->load->view('sapras/penghapusan/tambah', $data);
            $this->load->view('layoutsapras/footer');
        } else {
            $this->M_penghapusan->proses_tambah();
            $this->session->set_flashdata('flash', 'Ditambahkan');
            redirect('sapras/penghapusan');
        }
    }
    ...
    public function filter()
    {
        ...
        $this->load->view('layoutsapras/topbar');
        $this->load->view('layoutsapras/sidebar');
        $this->load->view('sapras/penghapusan/filter');
        $this->load->view('layoutsapras/footer');
    }
    ...
    public function laporan()
    {
        ...
        // die($tgl_awal);
        $this->load->view('sapras/penghapusan/laporan', $data);
        // title dari pdf
        ...
        $html = $this->load->view('sapras/penghapusan/laporan', $this->data, true);
