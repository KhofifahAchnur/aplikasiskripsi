...
class Buku extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('sapras/buku/index', $data);
    ...
    public function tambah()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layoutsapras/topbar');
            $this->load->view('layoutsapras/sidebar');
            $this->load->view('sapras/buku/tambah');
            $this->load->view('layoutsapras/footer');
        } else {
            $this->M_buku->proses_tambah();
            $this->session->set_flashdata('flash', 'Ditambahkan');
            redirect('sapras/buku');
        }
    }
    ...
    public function edit($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layoutsapras/topbar');
            $this->load->view('layoutsapras/sidebar');
            $this->load->view('sapras/buku/edit', $data);
            $this->load->view('layoutsapras/footer');
        } else {
    ...
    public function filter()
    {
        ...
        $this->load->view('layoutsapras/topbar');
        $this->load->view('layoutsapras/sidebar');
        $this->load->view('sapras/buku/filter');
        $this->load->view('layoutsapras/footer');
    }
    ...
    public function laporan()
    {
        ...
        $this->load->view('sapras/buku/laporan', $data);
        ...
        $html = $this->load->view('sapras/buku/laporan', $this->data, true);
