...
class Pemeliharaan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('sapras/pemeliharaan/index', $data);
    ...
    public function edit($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layoutsapras/topbar');
            $this->load->view('layoutsapras/sidebar');
            $this->load->view('sapras/pemeliharaan/edit', $data);
            $this->load->view('layoutsapras/footer');
        } else {
    ...
    public function laporan()
    {
        ...
        $data['pemeliharaan'] = $this->M_pemeliharaan->lihat();
        $this->load->view('sapras/pemeliharaan/laporan', $data);
        ...
        $html = $this->load->view('sapras/pemeliharaan/laporan', $this->data, true);
