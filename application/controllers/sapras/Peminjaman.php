...
class Peminjaman extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('sapras/peminjaman/index', $data);
    ...
    public function tambah($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layoutsapras/topbar');
            $this->load->view('layoutsapras/sidebar');
            $this->load->view('sapras/peminjaman/tambah', $data);
            $this->load->view('layoutsapras/footer');
        } else {
    ...
    public function edit($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layoutsapras/topbar');
            $this->load->view('layoutsapras/sidebar');
            $this->load->view('sapras/peminjaman/edit', $data);
            $this->load->view('layoutsapras/footer');
        } else {
    ...
    public function laporan()
    {
        ...
        $data['pinjam'] = $this->M_peminjaman->lihat();
        $this->load->view('sapras/peminjaman/laporan', $data);
        ...
        $html = $this->load->view('sapras/peminjaman/laporan', $this->data, true);
