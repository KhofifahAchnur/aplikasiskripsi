...
class Kondisi_buku extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('sapras/kondisi_buku/index', $data);
    ...
    public function tambah($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('layoutsapras/topbar');
            $this->load->view('layoutsapras/sidebar');
            $this->load->view('sapras/kondisi_buku/tambah', $data);
            $this->load->view('layoutsapras/footer');
        } else {
    ...
    public function laporan()
    {
        ...
        $data['kondisi_buku'] = $this->M_kondisi_buku->lihat();
        $this->load->view('sapras/kondisi_buku/laporan', $data);
        ...
        $html = $this->load->view('sapras/kondisi_buku/laporan', $this->data, true);
